...
angular.module("App")
    ...
    .controller("homeCtrl", function ($scope , $firebaseArray,$firebaseObject,$q) {
        var refAdd = new Firebase("https://babaauth.firebaseio.com/add")
        ...
        var refDoing = new Firebase("https://babaauth.firebaseio.com/diong")
        ...
        var refReview = new Firebase("https://babaauth.firebaseio.com/review")
            ...
            refReview.on("value", function (snapshot) {
             ...
             var refDone = new Firebase("https://babaauth.firebaseio.com/done")
